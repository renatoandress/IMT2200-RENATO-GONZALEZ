...
En base a datos del censo del 2017 (Chile), se observa la población total (17.574.003), la distribución de edad por región y la cantidad de personas por manzana de la Región Metropolitana. Cambié el nombre de la imagen y me di el atado de usar Git para subir los archivos en el repositorio. Supongo que usaron un rango de edad [0,5],[6,14],[15,65] y (65,) para 'primeria infancia', 'infancia', 'adultez' y 'persona mayor'; y dado que la población adulta es la mayor en todas las regiones, acceder a la distribución de edades de adultos podría ser más informativo y se podrían pensar medidas (como promover natalidad o mejorar servicios de salud) con datos suficientes.<br><br>
PD: No pude hacer una imagen más grande, lo siento😿
